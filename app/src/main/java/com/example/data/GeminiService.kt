...
// --- Moshi parsed structures for our UI ---
@JsonClass(generateAdapter = true)
data class AIChefRecipeItem(
    val ingredientName: String,
    val quantity: String,
    val productId: String, // Can match p1-p16 or empty
...
object GeminiClient {
    ...
    val recipeItemsAdapter = moshi.adapter(Array<AIChefRecipeItem>::class.java)
}
